...
internal class GetProgrammingLanguagesUseCaseTest : BaseTest() {

    private lateinit var getProgrammingLanguagesUseCase: GetProgrammingLanguagesUseCase
    ...
    fun setUp() {
        getProgrammingLanguagesUseCase =
            GetProgrammingLanguagesUseCase(repository, dispatcherProvider, errorHandler)
    }
    ...
    fun `get programming languages success`() {
        testCoroutineRule.runBlockingTest {
            ...
            whenever(repository.getProgrammingLanguages()).thenReturn(list)

            val result = getProgrammingLanguagesUseCase.invoke(Unit)
    ...
    fun `get programming languages failure`() {
        testCoroutineRule.runBlockingTest {
            ...
            whenever(repository.getProgrammingLanguages()).thenThrow(exception)
