...
import com.example.githubtrending.databinding.FragmentProgrammingLanguagesBinding
...
class ProgrammingFragment : BaseViewModelFragment<ProgrammingViewModel, FragmentProgrammingLanguagesBinding>() {
    override fun viewModelClass(): KClass<ProgrammingViewModel> = ProgrammingViewModel::class

    override fun layout(): Int = R.layout.fragment_programming_languages
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainViewModel.filter.observe(viewLifecycleOwner) {
            vm.getLanguages(it.params.programmingLanguageCode)
        }
            ...
            binding.rv.withModels {
                state.filteredLanguages.forEach {
                    ...
                    filter {
                        ...
                        onClick { view ->
                            mainViewModel.onProgrammingLanguageSelected(item.name, item.code)
                            goBack(view)
                        }
                    }
